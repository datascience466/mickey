...
GrowthSW$treat <- ifelse(GrowthSW$revolutions > 0, "more than 0 revolution", "0 revolution")
...
0 revolution has a smaller growth min and max, compared to "more than 0 revolution". It might mean that this is more spread than 0 revolution.
...
#It exceeds the standard significance level of 0.05 in the context of a p-value of 0.06871. As a result, if we applied a significance level of 0.05, the null hypothesis would not be rejected. When evaluating the p-value and drawing conclusions, it's crucial to take into account other elements including the study design, the size of the effect, and the context of the investigation.
...
Its goal is to make it possible to measure various variables for a country's growth while maintaining rgdp60 as a constant.
`rgdp60` shows the value of GDP per capita in 1960, converted to 1960 US dollars.
...
#so according to this analysis, the main driver of economic growth is tradeshare, because when growth changes by 1 tradeshare will increase by either 2.233 or 1.813, while the the other variables have no or negative effects.
